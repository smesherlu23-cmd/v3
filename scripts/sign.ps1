...
(низкоуровневый хук клавиатуры, персистентность, перечисление процессов,
работа с чужими окнами) неизбежно похоже на infostealer, и без подписи
эвристики срабатывают гарантированно.
